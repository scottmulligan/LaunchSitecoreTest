  ...
  speakGlobal.component(["bclCollection"], function (Collection) {
    ...
    return speakGlobal.extend({}, Collection.prototype, {
      ...
      initialized: function () {
        ...
        this.loadTemplate();
        this.on("reset", this.renderItems, this);
      ...
      renderItems: function () {
        ...
        if (this.Items) {
          ...
          if (this.IsTemplateLoaded) {
            ...
            var checkIfLoaded = setInterval(renderItemWhenLoaded, 100);

            function renderItemWhenLoaded() {
              if (self.IsTemplateLoaded) {
                  clearInterval(checkIfLoaded);
                  self.resetHtml();
                  self.Items.forEach(self.renderItem, self);
              }
            }
          }
        }
